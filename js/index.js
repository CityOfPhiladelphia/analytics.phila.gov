(function(exports) {
  ...
  // otherwise, let's get fancy
    ...
    console.log("%cYo! Please poke around to your heart's content.", styles.big);
    console.log(" ");
    console.log("%cIf you find a bug or something, please report it over at %chttps://github.com/CityOfPhiladelphia/analytics.phila.gov/issues", styles.medium, styles.medium_link);
    console.log("%cLike it, but want a different front-end? The data reporting is its own tool: %chttps://github.com/CityOfPhiladelphia/analytics-reporter", styles.medium, styles.medium_link);
